...
from main_app.validators import RangeValidator, ReleaseYearValidator
...
class VideoGame(models.Model):
    ...
    rating = models.FloatField(
        validators=[RangeValidator(0.0, 10.0, "The rating must be between 0.0 and 10.0")]
    )

    release_year = models.IntegerField(
        validators=[ReleaseYearValidator(1990, 2023, "The release year must be between 1990 and 2023")]
    )
...
class Project(models.Model):
    ...
    def get_programmers_with_technologies(self):
        return self.programmers.prefetch_related('projects__technologies')
